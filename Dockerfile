# Adapted from https://github.com/ukaea/openmc_workshop/blob/main/Dockerfile - old neutronics workshop


# build with the following command, replace the 50 cores with however many you would like to use
# docker build -t williamjsmith15/omniflow/openmc --build-arg compile_cores=8 .

# run with the following command
# docker run -it williamjsmith15/omniflow/openmc

# TODO: Add tests here to test container builds okay
